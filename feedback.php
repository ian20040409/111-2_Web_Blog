							...
							<!-- Content -->
								<section>
									<h2>📄 網站意見回饋</h2>
													...
													<form method="post" action="db/feedback.php" onsubmit="return validateForm()">
														<div class="row gtr-uniform">
															...
															<div class="col-12">
																表單編號:
																<input type="text" name="rcode" id="rcode" value="" placeholder="表單編號:" />
...
try {
    ...
    if ($result->rowCount() > 0) {
        echo "<table>";
        echo "<tr><th>姓名</th><th>Email</th><th>表單編號</th><th>訊息</th><th>修改</th><th>刪除</th></tr>";
	...
	<!-- Scripts -->
		...
		<script>
			...
			document.addEventListener('DOMContentLoaded', function () {
			  var bookingCodeInput = document.querySelector('input[name="rcode"]');
